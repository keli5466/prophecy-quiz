export default [
	{
		...
		copyOther: "<p>They're charming like The Lovers!<br>They have many sides to their personality and they all come together in one perfect balance, despite all odds.</p><p>The lovers’ clasped hands show commitment to one another…and the harmonious blend of Washington and California fruits. Deep crimson sunset hues and fruiting trees emphasize passionate flavors like dark cherry, raspberry, and blackberry.</p><p>This wine is best shared with someone you care about — think romantic, starry-eyed evening. So pop open a bottle and get ready to fall in love</p>"
	},
	{
		score: 'e'
		quiztype: 'The Star'
		...
		copyOther: "<p>They sparkle like The Star!<br>They operate on a higher level and shine with a special light that attracts people of all kinds.</p><p>Twinkling lights up above call to mind the high altitudes of Italy’s delle Venezie region, where this wine’s grapes wait to devote their gifts to a bottle that pairs well with just about any meal. The flowing water at her feet represents the cool, refreshing characteristics of this Pinot Grigio. </p><p>We recommend pouring a glass when they want to slow things down and experience a little bit of heavenly rejuvenation.</p>"
	},
	{
		score: 'd'
		...
		copyOther: "<p>They're adventurous like The Traveler!<br>They're always on the go and constantly looking for new people, places, things, and adventures to enjoy.</p><p>The Traveler’s feisty spirit mimics the vibrant fruit from premiere California vineyards, used to make the finest of red wines. His ornate red clothing represents a plush, elegant taste - in wine and fashion. He delights all whom he greets along the way, and can’t help but draw a crowd.</p><p>This Pinot Noir delights the senses, and charms guests at dinner parties and date nights alike.</p>"
	},
	{
		score: 'c'
		...
		copyOther: "<p>They rule like the Emperor!<br>They're a pillar of strength amongst family and friends, and an obvious natural leader to anyone you meet.</p><p>Come experience the king of wines - a bold ruler with a passion and energy for life that lights up any chamber. Pour a glass and let rich flavor, deep color, and full experiences abound. The Emperor’s crimson robes represent the expressive dark fruit flavors of blackberry, plum, and raspberry found in this California Cabernet. </p><p>Enjoy this wine while holding court, or pair it with a celebratory dinner.</p>"
	},
	{
		score: 'b'
		...
		copyOther: "<p>They're lucky like the Goddess of Fortune!<br>They move swiftly from one event to the next, always making the most of whatever happenings life throws their way.</p><p>The Goddess of Fortune appears clearly amidst billowy clouds, calling to mind the cool, crisp style of a French Rosé. Her delicate pink garment alludes to the soft but powerful flavor of strawberries and raspberries, and her flowing peach locks hint at a tinge of stone fruit. </p><p>This rosé gets along with any kind of plate or person imaginable, and will bring plenty of prosperity to your next weekend brunch or outdoor party.</p>"
	},
	{
		score: 'a'
		...
		copyOther: "<p>They're wise like the High Priestess!<br>They're intuitive, trust their gut, and bring a refreshing attitude to everyday circumstances.</p><p>The High Priestess inspires creativity wherever she goes, helping us craft an expressive wine full of tropical aromas. Her flowing robes represent delicate layers, peeling back to reveal even deeper flavors, a captivating style of winemaking and a staple of the Marlborough region.</p><p>Gift your hostess with a bottle of Sauvignon Blanc during appetizer hour, or enjoy a glass while reflecting on the world around you.</p>"
	}
]
